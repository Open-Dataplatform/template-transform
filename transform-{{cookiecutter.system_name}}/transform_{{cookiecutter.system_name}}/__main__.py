...
from .transform import Transform{{cookiecutter.system_name|title}}
...
def __get_pipeline() -> Transform{{cookiecutter.system_name|title}}:
    ...
    try:
        return Transform{{cookiecutter.system_name|title}}(storage_account_url=account_url,
